...
class RobertaMTL(nn.Module):
    def __init__(self, model_name, model_config):
        ...
        self.clarity_classifier = nn.Linear(self.roberta.config.hidden_size, len(model_config.clarity_labels))
        self.evasion_classifier = nn.Linear(self.roberta.config.hidden_size, len(model_config.evasion_labels))
    ...
    def _freeze_layers(self):
        ...
        print(f"RoBERTa total layers: {total_layers}")
    ...
    def _print_trainable_parameters(self):
        ...
        print(f"RoBERTa Trainable ratio: {100 * trainable_params / total_params:.2f}%")
